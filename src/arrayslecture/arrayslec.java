...
//        String[] myArray = {"dory", "dory", "dory", "dory", "dory", "dory"};
//        Arrays.fill(myArray, 0, 3,"zorra");
//        for(String element : myArray){
//            System.out.println(element);
//        }
...
//
//        String[] cat = {"dory", "Dory"};
//        String[] cat2 = {"Dory", "dory"};
//        String[] cat3 = {"dory", "Dory"};
//        System.out.println(Arrays.equals(cat, cat2));
